  ...
  return (
    <>
      ...
      <PlantDetailsContainer>
        <PlantImage
          src={data.file ? data.file : "/images/placeholder.jpg"}
          alt="Plant image"
          width={100}
          height={100}
        />
        <DetailsContainer>
          ...
          <DetailsWrapper>
            ...
            <DetailValue>
              {new Date(data.lastwatering).toLocaleDateString("de-DE")}
            </DetailValue>
          </DetailsWrapper>
          <DetailsWrapper>
            <DetailCaption>Letztes umtopfen</DetailCaption>
            <DetailValue>
              {new Date(data.repotting).toLocaleDateString("de-DE")}
            </DetailValue>
          </DetailsWrapper>
      ...
      <StyledButtonWrapper>
        <StyledQRCodeButton onClick={toggleQrCodeModal}>
          QR Code drucken
        </StyledQRCodeButton>
      </StyledButtonWrapper>
      <Modal
      ...
      <PageViewerContainer>
        <StyledChangeButton onClick={handleRoutingToEditForm}>
          Daten ändern
        </StyledChangeButton>
        <StyledDeleteButton onClick={handleDeletePlant}>
          Pflanze löschen
        </StyledDeleteButton>
      </PageViewerContainer>
      <Navbar />
